...
const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento shadow-input row-span-1 flex flex-col rounded-xl border border-blue-500/30 bg-black/50 backdrop-blur-sm p-0 transition duration-200 hover:shadow-xl hover:border-blue-500/50 overflow-hidden",
        className,
      )}
    >
          ...
          {tech && (
            <div className="flex flex-wrap gap-1 mb-3 overflow-hidden max-h-12">
              {tech.slice(0, 4).map((item, index) => (
                <span
                  key={index}
                  className="px-2 py-1 bg-blue-500/20 text-gray-200 rounded-full text-xs border border-blue-500/30 whitespace-nowrap"
                >
                  {item}
                </span>
              ))}
        ...
        <div className="flex gap-2 mt-auto">
          {github && (
            <a
              ...
              rel="noopener noreferrer"
               className="flex items-center gap-1 px-3 py-1.5 bg-blue-500/20 text-gray-200 rounded-lg hover:bg-blue-500/30 transition-colors text-xs font-medium"
            >
          ...
          {live && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 px-3 py-1.5 border border-blue-500/50 text-gray-200 rounded-lg hover:bg-blue-500/20 transition-colors text-xs font-medium"
            >
    ...
    <div className={`fixed top-4 left-4 z-50 block md:hidden ${className}`}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
            className="absolute top-full mt-2 flex flex-col gap-2 bg-black/90 backdrop-blur-md rounded-2xl p-3 border border-blue-500/30"
          >
            {items.map((item, idx) => (
              <motion.div
                key={item.title}
              ...
              >
                <button
                  ...
                  className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-900/50 hover:bg-blue-500/20 transition-colors group min-w-[120px]"
                >
                  <div className="h-4 w-4 text-blue-400 group-hover:text-gray-200">{item.icon}</div>
      ...
      <button
        ...
        className="flex h-12 w-12 items-center justify-center rounded-xl bg-black/80 backdrop-blur-md border border-blue-500/30 hover:border-blue-500/40 transition-colors"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      className={`fixed left-6 top-1/2 transform -translate-y-1/2 z-50 hidden md:flex flex-col gap-3 bg-black/80 backdrop-blur-md rounded-2xl p-4 border border-blue-500/30 hover:border-blue-500/30 transition-colors ${className}`}
    >
      {items.map((item) => (
  ...
  return (
    <div className="relative">
      <button
        ...
        className="group flex h-12 w-12 items-center justify-center rounded-xl bg-gray-900/50 hover:bg-blue-500/20 border border-blue-500/20 hover:border-blue-500/30 transition-all duration-300 hover:scale-110"
      >
        <div className="h-5 w-5 text-blue-400 group-hover:text-gray-200 transition-colors">
          {icon}
        </div>
      </button>
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="absolute left-full ml-3 top-1/2 transform -translate-y-1/2 px-3 py-2 bg-black/90 backdrop-blur-md rounded-lg border border-blue-500/30 whitespace-nowrap z-60"
          >
      ...
      <div className="min-h-screen text-white overflow-x-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 py-20 w-full">
            <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              <div className="flex justify-center md:justify-end">
                <div className="relative w-full max-w-sm aspect-square rounded-2xl border border-blue-500/30 bg-black/40 backdrop-blur-sm overflow-hidden">
                  <AsciiArt
                    src="/images/logo.jpg"
                    resolution={300}
                    color="#38bdf8"
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-lg text-blue-400 max-w-2xl mx-auto md:mx-0 mb-12">
        ...
        <section id="about" className="relative py-20 px-4 ml-0 md:ml-20">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-blue-500 to-sky-500 bg-clip-text text-transparent">
              About Me
            </h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-blue-900/20 to-sky-900/20 p-8 rounded-2xl border border-blue-500/30">
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <p className="text-blue-400">Indian Institute of Information Technology, Jabalpur</p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-lg hover:from-blue-700 hover:to-sky-700 transition-all duration-300 transform hover:scale-105 font-medium"
                >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {recognition.map((item, i) => (
                <div
                  key={i}
                  className="flex items-start gap-4 bg-gradient-to-br from-gray-900/50 to-black/50 p-6 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300"
                >
                  ...
                  <div>
                    <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 mb-1">
                      ...
                      <span className="text-xs text-blue-400 whitespace-nowrap">{item.date}</span>
                    </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {(Object.entries(skills) as [SkillCategory, string[]][]).map(([category, skillList]) => (
                <div
                  key={category}
                  className="bg-gradient-to-br from-gray-900/50 to-black/50 p-6 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300"
                >
                  ...
                  <div className="space-y-2">
                    {skillList.map((skill, index) => (
                      <div
                        key={index}
                        className="px-3 py-2 bg-blue-500/15 text-gray-200 rounded-lg text-sm border border-blue-500/30"
                      >
                        {skill}
                      </div>
                    ))}
        ...
        <section id="contact" className="relative py-20 px-4 ml-0 md:ml-20">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-sky-500 bg-clip-text text-transparent">
              Lets Connect
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <a
                ...
                className="flex items-center justify-center gap-3 p-6 bg-gradient-to-br from-blue-900/20 to-sky-900/20 rounded-2xl border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div className="flex justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-4 bg-gradient-to-r from-blue-600 to-sky-600 rounded-full hover:from-blue-700 hover:to-sky-700 transition-all duration-300 transform hover:scale-110"
              >
